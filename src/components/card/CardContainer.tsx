    ...
    <div className='CardContainer'>
        <div className='heading' >
            ...
            <div className='button-container'>
                <p ref={streamRef} onClick={(e) => {toggleClass(e.target,'stream')}} className='content active'>Streaming</p>
                <p ref={onTvRef} onClick={(e) => {toggleClass(e.target, 'ontv')}} className='content'> On TV</p>
            </div>
